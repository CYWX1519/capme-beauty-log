...
namespace BeautyLog
{
    ...
    public static class Log
    {
        ...
        public static void Debug(string log, StackTrace stackTrace)
        {
            LogManager.WriteLine(LogType.INFO, log, stackTrace);
        }
        ...
        /// <param name="log">日志数据</param>
        /// <param name="stackTrace">堆栈数据</param>
        public static void Info(string log, StackTrace stackTrace)
        {
            LogManager.WriteLine(LogType.INFO, log, stackTrace);
        }
        ...
        /// <param name="log">日志数据</param>
        /// <param name="stackTrace">堆栈数据</param>
        public static void Warn(string log, StackTrace stackTrace)
        {
            LogManager.WriteLine(LogType.WARN, log, stackTrace);
        }
        ...
        /// <param name="log">日志数据</param>
        /// <param name="stackTrace">堆栈数据</param>
        public static void Error(string log, StackTrace stackTrace)
        {
            LogManager.WriteLine(LogType.ERROR, log, stackTrace);
        }
